...
public class Account 
{
     ...
     * @return loginState
     */
    public boolean Login(LinkedList <Account> users)
    {
        if(loginState == true)
        {
    ...
    private boolean checkAnyLogin(LinkedList <Account> users)
    {
...
/**
 ...
 /**
     ...
     * @return If it blocked return true, otherwise false
     */
     ...
     */
    public void viewInbox(LinkedList <Account> users)
    {
        if(loginState != true)
        {
            System.out.println("Have to be login " + username);
     ...
     * @param users accounts was messaged
     */
    public void viewOutbox(LinkedList <Account> users)
    {
        if(loginState != true)
        {
            System.out.println("Have to be login " + username);
     ...
     */
    public void viewInteraction(Account account,LinkedList <Account> users )
    {
        if(loginState != true)
        {
            System.out.println("Have to be login " + username);
