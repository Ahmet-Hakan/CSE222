...
public class Account 
{
    ...
    private LDLinkedList <Message> message;
    private LDLinkedList <Account> followings;
    private LDLinkedList <Account>followers;
    private LDLinkedList <Account> blocks;
    ...
    Account (int id,String name, String date, String loc)
    {
        ...
        message = new LDLinkedList<Message>();
        followings = new LDLinkedList<Account>();
        followers = new LDLinkedList<Account>();
        blocks = new LDLinkedList<Account>();
    }
     ...
     */
    public LDLinkedList <Account> getFollowings()
    {
        return followings;
    }
     ...
     * @return loginState
     */
    public boolean Login(LDLinkedList <Account> users)
    {
        if(loginState == true)
        {
    ...
    private boolean checkAnyLogin(LDLinkedList <Account> users)
    {
...
/**
 ...
 /**
     ...
     * @param users accounts was messaged
     */
    public void viewOutbox(LDLinkedList <Account> users)
    {
        if(loginState != true)
        {
            System.out.println("Have to be login " + username);
     ...
     */
    public void viewInteraction(Account account,LDLinkedList <Account> users )
    {
        if(loginState != true)
        {
            System.out.println("Have to be login " + username);
